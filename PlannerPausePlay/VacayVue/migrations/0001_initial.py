# Generated by Django 5.0.3 on 2024-03-22 06:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('employee', 'Employee'), ('company', 'Company')], default='employee', max_length=20)),
                ('Email', models.EmailField(max_length=254, unique=True)),
                ('join_date', models.DateTimeField(blank=True, null=True)),
                ('username', models.CharField(max_length=225, null=True)),
                ('CompanyID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employees', to='VacayVue.companies')),
            ],
        ),
        migrations.CreateModel(
            name='Requests',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True)),
                ('user_type', models.CharField(choices=[('employee', 'Employee'), ('company', 'Company')], max_length=20)),
