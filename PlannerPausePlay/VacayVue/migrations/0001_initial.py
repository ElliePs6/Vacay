    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('υπάλληλο', 'Υπάλληλο'), ('εταιρία', 'Εταιρία'), ('διαχειριστής', 'Διαχειριστής')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leave_type', models.ForeignKey(default='Κανονική Άδεια', on_delete=django.db.models.deletion.CASCADE, to='VacayVue.leavetype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_set_holiday', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leave_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balances', to='VacayVue.leavetype')),
